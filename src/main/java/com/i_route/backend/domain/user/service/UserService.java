...
public class UserService {
    ...
    public DuplicateCheckResponse checkSingleField(String type, String value) {
        ...
        if (isDuplicate) {
            return new DuplicateCheckResponse(true, java.util.List.of(fieldName),"이미 사용 중인 " + fieldName + "입니다.");
        }

        return new DuplicateCheckResponse(false, java.util.List.of(), "사용 가능한 " + fieldName + "입니다.");
    }
}